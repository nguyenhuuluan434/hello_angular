...
export declare class Datagrid implements AfterContentInit, AfterViewInit, OnDestroy {
    ...
    constructor(columnService: HideableColumnService, filters: FiltersProvider, organizer: DatagridRenderOrganizer, page: Page, sort: Sort, items: Items, expandableRows: ExpandableRowsCount, selection: Selection, rowActionService: RowActionService);
